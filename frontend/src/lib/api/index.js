...
export const student = {
  ...
  updateInfo:   (body)       => apiFetch('/api/student/update-info',  { method: 'POST', body: JSON.stringify(body) }),
};
...
export const teacher = {
  ...
  updateInfo:          (body)   => apiFetch('/api/teacher/update-info',  { method: 'POST', body: JSON.stringify(body) }),
};
